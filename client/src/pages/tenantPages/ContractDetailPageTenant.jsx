  ...
  return (
    <main className="mb-12 mt-4">
      ...
      <div className="flex flex-col gap-2 items-center mt-4 text-center">
        ...
        <div>
          <h5 className="font-robotoNormal">
            <span className="font-medium">Rent Amount</span>: RS.{" "}
      ...
      <div className="w-11/12 mx-auto text-justify mt-6">
        ...
        <p>
          ...
          <strong>RS {format(contractDetail?.rentAmount)}</strong> per month.
          Total Rent amount of{" "}
          <strong>RS {format(calculateTotalRent())}</strong> shall be due and
        ...
        <p>
          The Tenant shall pay a refundable security deposit to the Owner.
          The deposit will be refunded at the end of the tenancy after deducting unpaid bills, 
          damages (if any), or pending dues.
        </p>
        <br />
        <h5>4. Termination of Agreement</h5>
        <p>
        ...
        <br />
        <h5>5. Use of Property</h5>
        <p>The Premises shall be used only for residential purposes.
           The Tenant shall not sublet the premises without written permission of the Owner.
           No illegal or objectionable activities shall be carried out.</p>
        <br></br>
        <h5>6. Entire Agreement</h5>
        <p>
        ...
        <br />
        <h5>9. Assignment and Binding Effect</h5>
        <p>
