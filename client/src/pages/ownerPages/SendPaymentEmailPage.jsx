  ...
  const handleSendConfirmation = (e) => {
    ...
    const emailTemplate = {
      ...
      Dear ${rentDetail?.tenant?.firstName} ${rentDetail?.tenant?.lastName},</p>
        ...
        rentDetail?.currentRentDate.from
      )}. The total rent amount is RS ${format(
        calculateTotalRent(
          rentDetail?.paymentPlan,
          rentDetail?.realEstate.price
        )
      )} for RS ${format(rentDetail?.realEstate?.price)} per month.
              </p>
              <p>
                ...
                Please use the phone number I provided to get in touch with me.
              </p>
              <p>
